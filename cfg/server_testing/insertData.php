...
if (isset($_GET['data'])) {
   ...
   echo "entered php <br> <br>";
    ...
    $result = mysql_query("INSERT INTO imu_rawdata_temp (imu_id, x, y, yaw, timestamp) VALUES('$imu_id','$x', '$y','$yaw', '$time')");
    $result1 = mysql_query("INSERT INTO imu_rawdata (imu_id, x, y, yaw, timestamp) VALUES('$imu_id','$x', '$y','$yaw', '$time')");
