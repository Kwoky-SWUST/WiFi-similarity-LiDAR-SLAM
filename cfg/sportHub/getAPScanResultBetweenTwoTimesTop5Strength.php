...
$query = mysql_query("SELECT * from wifi_raw_data where timestamp between '2016-07-25 13:00:00' and '2016-07-25 18:00:00' ORDER BY timestamp DESC") or die(mysql_error());
$wifi_info = "";
