...
vascocore_get_default_params( carmen_vascocore_param_p param, char *laser_type )
{
  ...
  else if (!strcmp(laser_type, "ldoem1000")) {
    param->verbose = 0;
    param->max_usable_laser_range = 30.0;
    param->local_map_max_range = 20.0;
    param->local_map_resolution = 0.01;
    param->local_map_kernel_len = 7;
    param->local_map_use_odometry = 1;
    param->local_map_num_convolve = 2;
    param->local_map_std_val = 0.0000001;
