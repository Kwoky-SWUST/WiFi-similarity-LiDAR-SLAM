...
#ifndef MODEL_LEARN_THIS_ROBOT_H_1392498
#define MODEL_LEARN_THIS_ROBOT_H_1392498

#include "basic.h"

// The number of sensor readings for this robot (typically 181 for a laser range finder)
#define SENSE_NUMBER 180 // scitos: 360 -- 180 in new 3d logfiles ...
...
#define TURN_RADIUS (0.21 * MAP_SCALE) // scitos: 0.21m
